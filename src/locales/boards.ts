...
export const boardsTranslationsPT = {
  "sidebar.boards": "Quadros",
  "sidebar.addBoard": "Adicionar Quadro",
  "sidebar.noBoards": "Ainda não há quadros",
  "sidebar.broadcasts": "Transmissões",
  
  "boards.nav.title": "Quadros",
  "boards.nav.subtitle": "Quadros de comunicação",
  
  "boards.boards.title": "Quadros de Comunicação",
  "boards.boards.subtitle": "Anúncios e atualizações para toda a equipe",
  "boards.boards.create": "Criar Quadro",
  "boards.boards.search": "Buscar quadros...",
  "boards.boards.empty": "Nenhum quadro encontrado",
  "boards.boards.emptyDescription": "Crie seu primeiro quadro de comunicação para compartilhar atualizações com sua equipe",
  "boards.boards.visibility.public": "Público",
  "boards.boards.visibility.private": "Privado",
  
  "boards.board.create.title": "Criar Quadro",
  "boards.board.edit.title": "Editar Quadro",
  "boards.board.name": "Nome do Quadro",
  "boards.board.namePlaceholder": "ex., Atualizações da Empresa, Notícias da Equipe",
  "boards.board.description": "Descrição",
  "boards.board.descriptionPlaceholder": "Para que serve este quadro?",
  "boards.board.visibility": "Visibilidade",
  "boards.board.visibility.publicLabel": "Público - Todos os usuários podem ver",
  "boards.board.visibility.privateLabel": "Privado - Apenas membros",
  "boards.board.save": "Salvar Quadro",
  "boards.board.cancel": "Cancelar",
  "boards.board.delete": "Excluir Quadro",
  "boards.board.deleteConfirm": "Tem certeza de que deseja excluir este quadro?",
  
  "boards.members.title": "Membros",
  "boards.members.add": "Adicionar Membros",
  "boards.members.admin": "Administrador",
  "boards.members.member": "Membro",
  "boards.members.type.user": "Usuário",
  "boards.members.type.team": "Equipe",
  "boards.members.role": "Função",
  "boards.members.remove": "Remover",
  "boards.members.empty": "Ainda não há membros",
  "boards.members.selectUser": "Selecionar Usuário",
  "boards.members.selectTeam": "Selecionar Equipe",
  "boards.members.type": "Tipo de Membro",
  "boards.members.confirmRemove": "Tem certeza de que deseja remover este membro?",
  "boards.members.adding": "Adicionando...",
  "boards.members.addMember": "ADICIONAR MEMBRO",
  
  "boards.messages.title": "Mensagens",
  "boards.messages.create": "Publicar Mensagem",
  "boards.messages.edit": "Editar Mensagem",
  "boards.messages.editDescription": "Atualize o conteúdo da sua publicação",
  "boards.messages.delete": "Excluir Mensagem",
  "boards.messages.deleteConfirm": "Tem certeza de que deseja excluir esta mensagem?",
  "boards.messages.title.label": "Título (opcional)",
  "boards.messages.title.placeholder": "Título da mensagem",
  "boards.messages.content": "Conteúdo",
  "boards.messages.contentPlaceholder": "Escreva sua mensagem aqui...",
  "boards.messages.pin": "Fixar Mensagem",
  "boards.messages.unpin": "Desafixar Mensagem",
  "boards.messages.pinned": "Fixado",
  "boards.messages.startsAt": "Data de início (opcional)",
  "boards.messages.endsAt": "Data de fim (opcional)",
  "boards.messages.empty": "Ainda não há mensagens",
  "boards.messages.emptyDescription": "Seja o primeiro a publicar uma mensagem",
  "boards.messages.postedBy": "Publicado por",
  "boards.messages.adminOnly": "Apenas administradores podem publicar mensagens",
  "boards.messages.posting": "PUBLICANDO...",
  "boards.messages.postMessage": "PUBLICAR MENSAGEM",
  
  "boards.actions.save": "Salvar",
  "boards.actions.cancel": "Cancelar",
  "boards.actions.delete": "Excluir",
  "boards.actions.edit": "Editar",
  "boards.actions.back": "Voltar aos Quadros",
  
  "boards.error.loadBoards": "Falha ao carregar quadros",
  "boards.error.loadMessages": "Falha ao carregar mensagens",
  "boards.error.createBoard": "Falha ao criar quadro",
  "boards.error.updateBoard": "Falha ao atualizar quadro",
  "boards.error.deleteBoard": "Falha ao excluir quadro",
  "boards.error.postMessage": "Falha ao publicar mensagem",
  "boards.error.noAccess": "Você não tem acesso a este quadro",
  
  "boards.success.boardCreated": "Quadro criado com sucesso",
  "boards.success.boardUpdated": "Quadro atualizado com sucesso",
  "boards.success.boardDeleted": "Quadro excluído com sucesso",
  "boards.success.messagePosted": "Mensagem publicada com sucesso",
  "boards.success.messageUpdated": "Mensagem atualizada com sucesso",
  "boards.success.messageDeleted": "Mensagem excluída com sucesso",
  
  // Boards form buttons
  "boards.cancel": "❌ Cancelar",
  "boards.createBoard": "✅ CRIAR QUADRO",
  "boards.saving": "⏳ SALVANDO...",
  
  // Boards plugin (in Plugins page)
  "plugins.boards.title": "Quadros",
  "plugins.boards.description": "Quadros de comunicação e anúncios da equipe",
};
