...
export const genericEventNames = {
    ...
    cleaningStatuses: genericSlices.slices.cleaningStatuses.eventNames,
...
export const genericInternalActions = {
    ...
    cleaningStatuses: genericSlices.slices.cleaningStatuses.actions,
...
export const genericActions = {
    ...
    cleaningStatuses: publicActions(genericInternalActions.cleaningStatuses),
